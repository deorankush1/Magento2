<?php
namespace AD\CustomerAttribute\Setup;
...
class InstallData implements InstallDataInterface
{
    ...
    public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        /* create customer sales_code attribute */
        ...
        $sampleAttribute = $customerSetup->getEavConfig()->getAttribute(Customer::ENTITY, 'sales_code')->addData(
            [
